...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      <header className="absolute top-0 left-0 w-full z-20 flex justify-end p-6 gap-4">
  ...
  {userEmail ? (
    <>
      ...
      <button
        ...
        className="text-sm border border-white/30 px-3 py-1 rounded-lg hover:bg-white/10 transition"
      >
        Cerrar sesión
      </button>
    </>
      ...
      <section className="relative z-10 flex min-h-screen items-start pt-32">
        <div className="mx-auto w-full max-w-7xl px-6 py-16 md:px-10">
          <div className="max-w-3xl">
            ...
            Debug email: {userEmail ?? "sin sesión"}
            </p>
